...
function read8(address)
  return memory.read_u8(address, "RAM")
end
...
function endFrame()
  ...
  gui.text(TEXT_POS_X, TEXT_POS_Y+15, "pos y: "..formatByteFrac(posY, subPosY, false))
  gui.text(TEXT_POS_X, TEXT_POS_Y+15+20, 'vel x: '..formatByteFrac(velX, subVelX, true))
  gui.text(TEXT_POS_X, TEXT_POS_Y+15+20+15, 'vel y: '..formatByteFrac(velY, subVelY, true))
end

event.onframeend(endFrame)