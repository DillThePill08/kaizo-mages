...
local ROM_SHA1 = gameinfo.getromhash()
...
or ROM_SHA1 == "A7B5AB31DB66EC035BCACA35D85317872BF6C698" then --NES 2.0
  console.log("Detected game: Micro Mages 2019")
...
or ROM_SHA1 == "3293101D7BBD9E8D4818CDB02F8323620624A236" then --NES 2.0
  console.log("Detected game: Micro Mages Second Quest")
  GAME_VERSION = 1
  LABELS.Map_worldDigit = 0xBD
  LABELS.Map_scrollY = 0xCC
  LABELS.Actor_px = 0x4A
  ...
  GAME_VERSION = 2
  console.log("Detected game: Micro Mages Custom Quest (v1.0.8)")
  LABELS.Map_worldDigit = 0xBD
...
function read8(address)
  if address < 0x2000 then
    return memory.readbyte(address & 0x7FF, "RAM")
  elseif address >= 0x8000 then
    return memory.readbyte(address - 0x8000, "PRG ROM")
  end 
  return 0
end
...
function read16(address)
  if address < 0x2000 then
    return memory.read_u16_le(address & 0x7FF, "RAM")
  elseif address >= 0x8000 then
    return memory.read_u16_le(address - 0x8000, "PRG ROM")
  end 
end
  ...
  for i = 0, 0xFF do
    ...
    for j = 0, 3 do
      ...
      if currentTile8 == 0x01 or currentTile8 == 0x02 then
        ...
        gui.drawRectangle(
          currentTileX + drawPosX - 1,
          currentTileY + drawPosY - 1,
          drawWidth + 1,
          drawHeight + 1,
          0, 
          HITBOX_COLOR
